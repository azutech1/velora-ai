      ...
      <section className="relative px-5 pb-16 pt-6 sm:px-8 lg:px-10">
        <header className="mx-auto flex max-w-7xl items-center justify-between">
          ...
          <div className="hidden items-center gap-3 md:flex">
            ...
            <Link href="/dashboard" className="rounded-lg bg-mint px-4 py-2 text-sm font-bold text-[#031018] shadow-neon transition hover:scale-[1.02]">
              Launch App
            </Link>
          </div>
        </header>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 py-16 lg:grid-cols-[1.02fr_0.98fr] lg:py-24">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            <div className="inline-flex items-center gap-2 rounded-full border border-mint/20 bg-mint/10 px-4 py-2 text-sm text-mint shadow-neon">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/dashboard" className="inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-mint to-cyan px-5 py-3 font-bold text-[#031018] shadow-neon transition hover:scale-[1.02]">
