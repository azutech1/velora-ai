...
export const initialAIAgents: VeloraAgent[] = [
  {
    ...
    confidenceScore: 88,
    recentActions: ["Checked allocation policy", "Queued rebalance approval"],
  ...
  },
  {
    ...
    confidenceScore: 84,
    recentActions: ["Prioritized Arc-native route", "Checked LI.FI fallback"],
  ...
  },
  {
    ...
    confidenceScore: 79,
    recentActions: ["Prepared reminder template", "Requested policy review"],
  ...
  },
  {
    ...
    confidenceScore: 91,
    recentActions: ["Scanned quote failures", "Kept manual approval required"],
  ...
  },
  {
    ...
    confidenceScore: 76,
    recentActions: ["Prepared empty-state report", "Waiting for activity data"],
