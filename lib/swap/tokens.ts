...
export const SWAP_TOKENS: SwapToken[] = [
  { symbol: "USDC", name: "USD Coin", decimals: 6, mockPrice: 1, contractAddress: (getConfiguredTokenAddress("USDC", 5042002) ?? UNCONFIGURED_TOKEN_ADDRESS) as Address, category: "stablecoin" },
  { symbol: "EURC", name: "Euro Coin", decimals: 6, mockPrice: 1.08, contractAddress: (getConfiguredTokenAddress("EURC", 5042002) ?? UNCONFIGURED_TOKEN_ADDRESS) as Address, category: "stablecoin" },
  { symbol: "USDT", name: "Tether USD", decimals: 6, mockPrice: 1, contractAddress: (getConfiguredTokenAddress("USDT", 5042002) ?? UNCONFIGURED_TOKEN_ADDRESS) as Address, category: "stablecoin" },
  { symbol: "WETH", name: "Wrapped Ether", decimals: 18, mockPrice: 3850, contractAddress: UNCONFIGURED_TOKEN_ADDRESS, category: "wrapped asset" },
